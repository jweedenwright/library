...
If you utilize doc blocks in your project, we recommend following the same pattern, and creating a \_[directory]\*\*docs.md markdown file per directory containing all your doc blocks for that folder of models.
